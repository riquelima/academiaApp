...
export const IconDumbbell = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M20.57 14.86L19.25 13.4c.45-.5.75-1.15.75-1.9 0-1.65-1.35-3-3-3s-3 1.35-3 3c0 .75.3 1.4.75 1.9l-1.33 1.44C12.39 14.55 12 15.2 12 16V18c0 1.1.9 2 2 2h5c1.1 0 2-.9 2-2v-2c0-.8-.39-1.45-1.43-1.14zM6.5 11.5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5S8.83 13 8 13s-1.5-.67-1.5-1.5zM5 16c0-1.1.9-2 2-2h1c0-1.65-1.35-3-3-3S2 9.35 2 11c0 1.5.94 2.77 2.25 3.08L3.4 15.2c-.45.5-.75 1.15-.75 1.9C2.65 18.03 3.47 19 4.5 19H5v-3zM18 16c0 .55-.45 1-1 1s-1-.45-1-1v-1h2v1zM7 16c0 .55-.45 1-1 1s-1-.45-1-1v-1h2v1z" />
  </svg>
);
...
export const IconDollar = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M11.8 10.9c-2.27-.59-3-1.2-3-2.15 0-.9.6-1.75 2.1-1.75 1.3 0 2 .6 2.1 1.7H15c-.1-1.7-1.2-3.25-3-3.25S9 6.15 9 7.75c0 1.71 1.4 2.53 3.25 3 .9.23 1.25.56 1.25 1.05 0 .6-.75 1-1.5 1S11 12.45 11 11.7H9c.13 1.74 1.27 2.8 3 2.8s3-1.12 3-2.5c0-1.25-.7-2.05-2.2-2.45zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z" />
  </svg>
);

export const IconSparkles = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M12 2l2.34 7.19L22 12l-7.66 2.81L12 22l-2.34-7.19L2 12l7.66-2.81L12 2zm0 5l-1.2 3.7H7.1L10 12.8l-1.2 3.7L12 14.2l3.2 2.3-1.2-3.7 2.8-2.1h-3.7L12 7z"/>
  </svg>
);
